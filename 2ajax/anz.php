...
foreach($data as $date => $v){
    foreach($v as $record => $v2){
        ...
        if(empty($newrow)){       
			...
			$ins[$date][$record]['time']=$v2['time'];
			$ins[$date][$record]['teamA']=$v2['teamA'];
			$ins[$date][$record]['teamB']=$v2['teamB'];
			$ins[$date][$record]['odds_home']=$v2['odds_home'];
			$ins[$date][$record]['odds_draw']=$v2['odds_draw'];
			$ins[$date][$record]['odds_away']=$v2['odds_away'];
			$ins[$date][$record]['bet']=$v2['bet'];
			...
			$upd[$date][$record]['time']=$v2['time'];
			$upd[$date][$record]['teamA']=$v2['teamA'];
			$upd[$date][$record]['teamB']=$v2['teamB'];
			$upd[$date][$record]['odds_home']=$v2['odds_home'];
			$upd[$date][$record]['odds_draw']=$v2['odds_draw'];
			$upd[$date][$record]['odds_away']=$v2['odds_away'];
			$upd[$date][$record]['bet']=$v2['bet'];
...
$json_data=json_encode($upd_ins,JSON_UNESCAPED_UNICODE); 
echo $json_data;
