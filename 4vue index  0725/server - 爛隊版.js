        ...
        for(i=0;i<3;i++){
         ...
         /*    //向下挖 span 資料
           ...
           /*  anz_data[rightdate][idx]['time']=time;
			...
			anz_data[i]['date']='2018-08-20';
			anz_data[i]['time']='36:00';
            anz_data[i]['teamA']='爛隊';
            anz_data[i]['teamB']='更爛隊';
            anz_data[i]['odds_home']='513';
            anz_data[i]['odds_draw']='777';
            anz_data[i]['odds_away']='123';
            anz_data[i]['bet']='666'; 
